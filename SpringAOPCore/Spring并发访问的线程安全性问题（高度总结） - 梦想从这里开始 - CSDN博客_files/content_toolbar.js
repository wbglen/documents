 ...
 * 二级域名 getSecondaryDomain
  ...
  //  festival customize
    var start_time = 1552492800, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
        end_time = 1552579200,  // toolbar 特殊样式结束时间戳
        ...
        // }
        if(now_time > start_time && now_time < end_time ){
          logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/csdn-pai.jpg">';
          logo_title = 'csdn-pai';
        }
