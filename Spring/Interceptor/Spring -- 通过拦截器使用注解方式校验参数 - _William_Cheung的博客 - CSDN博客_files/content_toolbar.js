 ...
 * 二级域名 getSecondaryDomain
  ...
  //  festival customize
    var start_time = 1556640000, // toolbar 特殊样式起始时间戳new Date(2018,11,29).getTime()/1000
        end_time = 1556985600,  // toolbar 特殊样式结束时间戳
        ...
        // }
        if(now_time > start_time && now_time < end_time ){
          logo_tpl = '<img src="//csdnimg.cn/cdn/content-toolbar/csdn-LaborDay.jpg">';
          logo_title = '劳动节';
        }
  ...
  var tpl ='\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone '+skin+fixed+'">\
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix" id="nav-left-menu">\
            ...
            <li><a href="https://h5.youzan.com/v2/showcase/homepage?alias=BUj3rrGa2J&ps=760" target="_blank" title="商城">商城</a></li>\
            <li><a href="//huiyi.csdn.net/" title="活动">活动</a></li>\
            <li class="vip-caise"><a href="https://mall.csdn.net/vip" title="VIP会员">VIP会员</a><span class="vip-totast"><img src="https://csdnimg.cn/public/common/toolbar/images/vipimg.png" /></span></li>\
          ...
          <div class="pull-right login-wrap '+loginMark+'">\
            ...
            <li class="toolbar-tracking csdn-tracking-statistics tracking-click" data-mod="popu_369"><a href="#" style="padding:0"></a></li>\
              ...
              <li class="gitChat baidu-app-btn"><a class="" href="javascript:;"><img src="https://csdnimg.cn/public/common/toolbar/images/baiduapplogo@2x.png" alt="" class="money"><span>小程序</span></a>\
                <div class="baiduControl">\
                <p>百度APP扫码<br/>\
                关注智能小程序</p>\
                <span>\
                  <img src="https://csdnimg.cn/public/common/toolbar/images/baiduqr.png" />\
                  <em>阅读体验更佳</em>\
                </span>\
              </li>\
...
$(function(){
  ...
  function goFn(obj,txt){
    ...
    for(var i=0;i<myNav.length;i++){
        ...
        if(currenturl.indexOf('//gitbook.cn')!=-1 && currenturl.indexOf('vip') ==-1){
          myNav[9].className="active";
        }
